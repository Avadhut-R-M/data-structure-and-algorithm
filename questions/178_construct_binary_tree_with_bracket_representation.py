"""
Question - Construct a binary tree from a string consisting of parenthesis and integers.
...
if __name__ == "__main__":
    ...
    solution = Solution()
    print(solution.createTree(string))
